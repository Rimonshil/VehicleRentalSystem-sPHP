...
$EM->InputValidation([
	new HTTP\InputValidation("VehicleLicenseNumber", true),
...
$EM->ListColumn([
	...
	new HTML\UI\Datagrid\Column("" . ($Caption = "VehicleLicenseNumber	") . "", "{$Caption}", null),
	new HTML\UI\Datagrid\Column("{$Entity}" . ($Caption = "VehicleType ") . "", "{$Caption}", null),
    new HTML\UI\Datagrid\Column("{$Entity}" . ($Caption = "VehicleBrandName  ") . "", "{$Caption}", null),
...
$EM->OrderBy("VehicleLicenseNumber");
$EM->Order("ASC");
...
if(isset($_POST["btnInput"])){
	...
	$EM->InputUIHTML([
		...
		HTML\UI\Field(HTML\UI\Input("" . ($Caption = "User") . "", $EM->InputWidth(), null, null, INPUT_TYPE_TEXT), "{$Caption}", true, null, $EM->FieldCaptionWidth()),
