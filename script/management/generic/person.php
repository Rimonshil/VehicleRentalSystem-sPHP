...
$EM->InputValidation([
	...
	new HTTP\InputValidation("{$Entity}LastName", true),
...
if(isset($_POST["btnInput"])){
	...
	$EM->InputUIHTML([
		...
		HTML\UI\Field(HTML\UI\Input("{$Entity}" . ($Caption = "LastName") . "", $EM->InputWidth(), null, true), "{$Caption}", null, null, $EM->FieldCaptionWidth()),
...
if(isset($_POST["btnExport"])){
	...
	print $Table["{$Entity}"]->Export(
		"{$Entity}FirstName , {$Entity}LastName,{$Entity}Email,{$Entity}BirthDate",
